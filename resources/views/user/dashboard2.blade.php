<x-app-layout>
    <x-slot name="header">
        ...
        Account Name: {{ $data[0]['account_name'] }}
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-info">
                <div class="inner">
                  ...
                  <h3> <span class="dollars1">{{ $data[0]['balance'] }} </span></h3>
...
<a target="_blank" href="{{ url('print/'.$acc) }}" class="btn btn-primary btn-lg text-dark">Print statement</a>
</div>
